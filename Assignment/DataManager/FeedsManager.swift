...
//        case MUSIC = "Music"
    ...
    static var feeds = [
        Section.STOCKTICKERS:  [
            Feed(stock: Stock(stock: "FORD", price: 72.19042874981784), news: nil),
            Feed(stock: Stock(stock: "FORD", price: -211.5509976763925), news: nil),
            Feed(stock: Stock(stock: "NVDA", price: 30.999642050562386), news: nil),
            Feed(stock: Stock(stock: "NVDA", price: -150.5328741940824), news: nil),
            Feed(stock: Stock(stock: "AMD", price: -117.59246397277423), news: nil),
            Feed(stock: Stock(stock: "ACN", price: 70.81894630569406), news: nil),
            Feed(stock: Stock(stock: "NVDA", price: -247.83003439647567), news: nil),
           
        ] ,
        Section.NEWSFEED:  [
            
            
            Feed(stock: nil, news: NewsFeed(author : "Issy Ronald, CNN",
