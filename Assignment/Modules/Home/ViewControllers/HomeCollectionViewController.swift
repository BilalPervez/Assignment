...
class HomeCollectionViewController: BaseViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        setupNavigationTitle(title: "Stock & NewFeed")
        showNavigationBar()
        runTimer()
    }
...
extension HomeCollectionViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        guard let headerSupplementaryView =
                collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader
                                                                , withReuseIdentifier: TitleHeaderView.reuseIdentifier, for: indexPath) as? TitleHeaderView else {
        ...
        switch viewModel.sectionTypes[indexPath.section] {
        case .stockTickers:
            headerSupplementaryView.textLabel.text = "Stock Tickers"
            return headerSupplementaryView
        case .newFeeds:
            headerSupplementaryView.textLabel.text = "News Feeds"
            return headerSupplementaryView
        case .remainingNewFeeds:
            headerSupplementaryView.textLabel.text = "More News"
            return headerSupplementaryView
        }
